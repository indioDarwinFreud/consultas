...
export class Migracion1634445997734 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "productos" ("id" varchar PRIMARY KEY NOT NULL, "nombre" varchar NOT NULL, "precio" integer NOT NULL, "tipo" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "categoriasId" varchar)`);
        await queryRunner.query(`CREATE TABLE "categorias" ("id" varchar PRIMARY KEY NOT NULL, "nombre" varchar NOT NULL)`);
        await queryRunner.query(`CREATE TABLE "cuentas" ("id" varchar PRIMARY KEY NOT NULL, "username" varchar NOT NULL, "email" varchar NOT NULL, "contraseña" integer NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_productos" ("id" varchar PRIMARY KEY NOT NULL, "nombre" varchar NOT NULL, "precio" integer NOT NULL, "tipo" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "categoriasId" varchar, CONSTRAINT "FK_3150a2e74c18cfaddca910c9a8a" FOREIGN KEY ("categoriasId") REFERENCES "categorias" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_productos"("id", "nombre", "precio", "tipo", "created_at", "updated_at", "categoriasId") SELECT "id", "nombre", "precio", "tipo", "created_at", "updated_at", "categoriasId" FROM "productos"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "productos" ("id" varchar PRIMARY KEY NOT NULL, "nombre" varchar NOT NULL, "precio" integer NOT NULL, "tipo" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "categoriasId" varchar)`);
        await queryRunner.query(`INSERT INTO "productos"("id", "nombre", "precio", "tipo", "created_at", "updated_at", "categoriasId") SELECT "id", "nombre", "precio", "tipo", "created_at", "updated_at", "categoriasId" FROM "temporary_productos"`);
